...
{
    public partial class frmCrMileageSelective : Form
    {
       
        public frmCrMileageSelective()
        {
            InitializeComponent();
        }
        ...
        private void crystalReportViewer1_Load(object sender, EventArgs e)
        {
            ...
            paramDiscreteValue.Value = frmRunningChart.vehicleno; 
            ...
            reportDocument.Load(@"H:\MIT\Regain\Project VMS\Reports\CrMileageSelective.rpt");
